...
# ---------------------------------------------------------------
# 1. Correct production data boundary
# ---------------------------------------------------------------
...
# ---------------------------------------------------------------
# 2. ACTUAL production structure builder
# ---------------------------------------------------------------
...
print()
print("STRUCTURE BUILD")
print("-" * 110)
print("structure states:", len(structure_states))
print("swings          :", len(structure_engine.swings))
print("events          :", len(structure_engine.events))
...
print("path length     :", len(query.path_vector))

# ---------------------------------------------------------------
# 5. Production experience records
# ---------------------------------------------------------------
...
# ---------------------------------------------------------------
# 8. Best match row-level inspection
# ---------------------------------------------------------------
...
top_mean_path = (
    sum(x[0] for x in top_group) / len(top_group)
)

bottom_mean_path = (
    sum(x[0] for x in bottom_group) / len(bottom_group)
)
