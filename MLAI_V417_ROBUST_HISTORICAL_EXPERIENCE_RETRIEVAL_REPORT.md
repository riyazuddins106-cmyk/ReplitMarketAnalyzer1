...
V4.1.7 explicitly tests whether historical experience retrieval produces a distinguishable neighbour set, whether that discrimination exists independently at H4, H8 and H16, and whether the integrated predictive decision provides incremental value over the conditional baseline.
